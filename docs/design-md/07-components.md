...
Do not redesign, reinterpret, simplify, modernize, or substitute this header.

The only content that changes between sites is the site name and its destination.
...
>
  <div class="layout-container container">
    ...
    <a
      class="title-header title-header-large"
      href="SITE_URL"
    >
      SITE NAME
    </a>
    ...
    <a
      class="title-header title-header-short"
      href="SITE_URL"
    >
      SHORT SITE NAME
    </a>
