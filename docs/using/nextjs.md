...
For Next.js and React apps. Tailwind v4 (CSS-first config) on UCSD tokens. For the rules and the full token list, read [`DESIGN.md`](../../DESIGN.md).
...
Everything above applies except the Next.js notes. If you aren't using Tailwind at all, import `@ucsd/tokens/css` and use `var(--ucsd-*)` directly — see [`other.md`](other.md).
