<!-- COPY of docs/layouts/README.md — do not edit here. Edit the source and run `npm run build`. -->
...
|---|---|---|
| `docs/layouts/content-page.md` | Long-form informational pages — policy, about, how-to, program detail. The workhorse. | two-column |
| `docs/layouts/landing-page.md` | Entry pages that route people onward. Stacked sections, no sidebar. | homepage |
| `docs/layouts/listing-page.md` | Indexes of repeating items — news, events, people, programs. Filter + results. | three-column |
