 ...
 * GENERATED by @ucsd/tokens — do not edit. Change values in Figma; see docs/figma.md.
 *
 ...
 *
 * GENERATED by @ucsd/tokens — do not edit. Equivalent to the documented four
 * imports, in the only order that works. Not for Bootstrap sites (use
 * @ucsd/bootstrap) or non-Tailwind stacks (import @ucsd/tokens/css alone).
 */
@import "tailwindcss";
