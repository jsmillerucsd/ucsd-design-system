...
export const shadcnTheme = {
  ...
  format: ({ dictionary }) => {
    ...
    return [
      ...
      ' * GENERATED by @jsmillerucsd/tokens. Do not edit; change MAP in formats/shadcn-theme.mjs.',
      ' *',
      ' * Import AFTER the Tailwind theme, which resets --color-* to initial:',
      ' *   @import "tailwindcss";',
      ' *   @import "@jsmillerucsd/tokens/css";',
      ' *   @import "@jsmillerucsd/tokens/tailwind";',
      ' *   @import "@jsmillerucsd/tokens/shadcn";   // <- this file',
      ' *',
